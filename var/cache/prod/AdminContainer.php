...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'prestashop_1.7.7.2', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestatest/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestatest/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestatest/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestatest/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestatest/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Applications/MAMP/htdocs/prestatest/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_b9a3a078a144563031cf8316ff35f2cad999641bdf3c8abb46093181da330fab');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/MAMP/htdocs/prestatest/var/cache/prod//localization');
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.7.2', '/Applications/MAMP/htdocs/prestatest', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.2', '/Applications/MAMP/htdocs/prestatest');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/MAMP/htdocs/prestatest/app',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/prestatest',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/prestatest/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                67 => 'ps_accounts',
                68 => 'ps_eventbus',
                69 => 'ps_searchbarjqauto',
            ],
            'ps_cache_dir' => '/Applications/MAMP/htdocs/prestatest/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/prestatest/var/cache/prod//doctrine/orm/Proxies',
